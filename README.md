...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,689 | 🐛 106 | 📅 2026-09-02
...
* ### Awesome List
  ...
  * [M-3LAB/awesome-industrial-anomaly-detection](https://github.com/M-3LAB/awesome-industrial-anomaly-detection) ⭐ 3,789 | 🐛 1 | 📅 2026-09-07 <img src="https://img.shields.io/github/stars/M-3LAB/awesome-industrial-anomaly-detection?style=social"/> : Paper list and datasets for industrial image anomaly detection.

  * [wenhwu/awesome-remote-sensing-change-detection](https://github.com/wenhwu/awesome-remote-sensing-change-detection) ⭐ 2,335 | 🐛 2 | 📅 2026-09-09 <img src="https://img.shields.io/github/stars/wenhwu/awesome-remote-sensing-change-detection?style=social"/> : List of datasets, codes, and contests related to remote sensing change detection.

  * [ZHOUYI1023/awesome-radar-perception](https://github.com/ZHOUYI1023/awesome-radar-perception) ⭐ 1,884 | 🐛 8 | 📅 2025-04-05 <img src="https://img.shields.io/github/stars/ZHOUYI1023/awesome-radar-perception?style=social"/> : A curated list of radar datasets, detection, tracking and fusion.

  * [xahidbuffon/Awesome\_Underwater\_Datasets](https://github.com/xahidbuffon/Awesome_Underwater_Datasets) ⭐ 708 | 🐛 4 | 📅 2025-05-22 <img src="https://img.shields.io/github/stars/xahidbuffon/Awesome_Underwater_Datasets?style=social"/> : Pointers to large-scale underwater datasets and relevant resources.
  ...
  * [ari-dasci/OD-WeaponDetection](https://github.com/ari-dasci/OD-WeaponDetection) ⭐ 247 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-01-05 <img src="https://img.shields.io/github/stars/ari-dasci/OD-WeaponDetection?style=social"/> : Datasets for weapon detection based on image classification and object detection tasks.
...
* ### Datasets Share Platform
  ...
  * [openvinotoolkit/datumaro](https://github.com/openvinotoolkit/datumaro) ⭐ 689 | 🐛 30 | 🌐 Python | 📅 2026-09-16 <img src="https://img.shields.io/github/stars/openvinotoolkit/datumaro?style=social"/> : Dataset Management Framework, a Python library and a CLI tool to build, analyze and manage Computer Vision datasets.
...
* ### Tools
  ...
  * #### Data Annotation
    ...
    * [Label Studio](https://github.com/HumanSignal/label-studio) ⭐ 28,297 | 🐛 950 | 🌐 TypeScript | 📅 2026-09-19 <img src="https://img.shields.io/github/stars/HumanSignal/label-studio?style=social"/> : Label Studio is a multi-type data labeling and annotation tool with standardized output format. [labelstud.io](https://labelstud.io/)
    ...
    * [CVAT](https://github.com/cvat-ai/cvat) ⭐ 16,751 | 🐛 590 | 🌐 Python | 📅 2026-09-19 <img src="https://img.shields.io/github/stars/cvat-ai/cvat?style=social"/> : Computer Vision Annotation Tool (CVAT). Annotate better with CVAT, the industry-leading data engine for machine learning. Used and trusted by teams at any scale, for data of any scale.

    * [labelme](https://github.com/wkentaro/labelme) ⭐ 16,175 | 🐛 166 | 🌐 Python | 📅 2026-09-18 <img src="https://img.shields.io/github/stars/wkentaro/labelme?style=social"/> : Image Polygonal Annotation with Python (polygon, rectangle, circle, line, point and image-level flag annotation).
    ...
    * [AnyLabeling](https://github.com/vietanhdev/anylabeling) ⭐ 3,482 | 🐛 50 | 🌐 Python | 📅 2026-08-30 <img src="https://img.shields.io/github/stars/vietanhdev/anylabeling?style=social"/> : Effortless data labeling with AI support from YOLO and Segment Anything! AnyLabeling = LabelImg + Labelme + Improved UI + Auto-labeling.
    ...
    * [opendatalab/labelU](https://github.com/opendatalab/labelU) ⭐ 1,675 | 🐛 32 | 🌐 Python | 📅 2026-07-28 <img src="https://img.shields.io/github/stars/opendatalab/labelU?style=social"/> : Uniform, Unlimited, Universal and Unbelievable Annotation Toolbox.

    * [Cartucho/OpenLabeling](https://github.com/Cartucho/OpenLabeling) ⭐ 963 | 🐛 18 | 🌐 Python | 📅 2022-07-06 <img src="https://img.shields.io/github/stars/Cartucho/OpenLabeling?style=social"/> : Label images and video for Computer Vision applications.
    ...
    * [cnyvfang/labelGo-Yolov5AutoLabelImg](https://github.com/cnyvfang/labelGo-Yolov5AutoLabelImg) ⚠️ Archived <img src="https://img.shields.io/github/stars/cnyvfang/labelGo-Yolov5AutoLabelImg?style=social"/> : 💕YOLOV5 semi-automatic annotation tool (Based on labelImg)💕一个基于labelImg及YOLOV5的图形化半自动标注工具。

    * [DarkLabel](https://github.com/darkpgmr/DarkLabel) ⭐ 392 | 🐛 21 | 📅 2021-09-04 <img src="https://img.shields.io/github/stars/darkpgmr/DarkLabel?style=social"/> : Video/Image Labeling and Annotation Tool.

    * [pylabel-project/pylabel](https://github.com/pylabel-project/pylabel) ⭐ 341 | 🐛 13 | 🌐 Python | 📅 2024-08-14 <img src="https://img.shields.io/github/stars/pylabel-project/pylabel?style=social"/> : Python library for computer vision labeling tasks. The core functionality is to translate bounding box annotations between different formats-for example, from coco to yolo.

    * [wufan-tb/AutoLabelImg](https://github.com/wufan-tb/AutoLabelImg) ⭐ 299 | 🐛 20 | 🌐 Python | 📅 2023-02-26 <img src="https://img.shields.io/github/stars/wufan-tb/AutoLabelImg?style=social"/> : auto-labelimg based on yolov5, with many other useful tools. AutoLabelImg 多功能自动标注工具。

    * [stephanecharette/DarkMark](https://github.com/stephanecharette/DarkMark) ⭐ 233 | 🐛 6 | 🌐 C++ | 📅 2026-01-31 <img src="https://img.shields.io/github/stars/stephanecharette/DarkMark?style=social"/> : Marking up images for use with Darknet.

    * [CVUsers/Auto\_maker](https://github.com/CVUsers/Auto_maker) ⭐ 205 | 🐛 3 | 🌐 Python | 📅 2021-01-18 <img src="https://img.shields.io/github/stars/CVUsers/Auto_maker?style=social"/> : 深度学习数据自动标注器开源 目标检测和图像分类（高精度高效率）。

    * [WangRongsheng/KDAT](https://github.com/WangRongsheng/KDAT) ⭐ 83 | 🐛 0 | 🌐 Python | 📅 2023-04-24 <img src="https://img.shields.io/github/stars/WangRongsheng/KDAT?style=social"/> : 一个专为视觉方向目标检测全流程的标注工具集，全称：Kill Object Detection Annotation Tools。

    * [sanfooh/quick\_yolo2\_label\_tool](https://github.com/sanfooh/quick_yolo2_label_tool) ⭐ 78 | 🐛 1 | 🌐 C# | 📅 2018-06-20 <img src="https://img.shields.io/github/stars/sanfooh/quick_yolo2_label_tool?style=social"/> : yolo快速标注工具 quick yolo2 label tool.

    * [AlturosDestinations/Alturos.ImageAnnotation](https://github.com/AlturosDestinations/Alturos.ImageAnnotation) ⭐ 70 | 🐛 5 | 🌐 C# | 📅 2021-01-29 <img src="https://img.shields.io/github/stars/AlturosDestinations/Alturos.ImageAnnotation?style=social"/> : A collaborative tool for labeling image data for yolo.

    * [2vin/yolo\_annotation\_tool](https://github.com/2vin/yolo_annotation_tool) ⭐ 55 | 🐛 3 | 🌐 C++ | 📅 2026-04-12 <img src="https://img.shields.io/github/stars/2vin/yolo_annotation_tool?style=social"/> : Annotation tool for YOLO in opencv.

    * [2vin/PyYAT](https://github.com/2vin/PyYAT) ⭐ 22 | 🐛 3 | 🌐 Python | 📅 2023-08-23 <img src="https://img.shields.io/github/stars/2vin/PyYAT?style=social"/> : Semi-Automatic Yolo Annotation Tool In Python.

    * [MrZander/YoloMarkNet](https://github.com/MrZander/YoloMarkNet) ⭐ 19 | 🐛 1 | 🌐 C# | 📅 2018-05-06 <img src="https://img.shields.io/github/stars/MrZander/YoloMarkNet?style=social"/> : Darknet YOLOv2/3 annotation tool written in C#/WPF.

    * [folkien/yaya](https://github.com/folkien/yaya) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-03-21 <img src="https://img.shields.io/github/stars/folkien/yaya?style=social"/> : YAYA - Yet annother YOLO annoter for images (in QT5). Support yolo format, image modifications, labeling and detecting with previously trained detector.

    * [LILINOpenGitHub/Labeling-Tool](https://github.com/LILINOpenGitHub/Labeling-Tool) ⭐ 5 | 🐛 0 | 📅 2022-05-03 <img src="https://img.shields.io/github/stars/LILINOpenGitHub/Labeling-Tool?style=social"/> : Free YOLO AI labeling tool. YOLO AI labeling tool is a Windows app for labeling YOLO dataset.

    * [MNConnor/YoloV5-AI-Label](https://github.com/MNConnor/YoloV5-AI-Label) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2022-04-03 <img src="https://img.shields.io/github/stars/MNConnor/YoloV5-AI-Label?style=social"/> : YoloV5 AI Assisted Labeling.

    * [mahxn0/Yolov3\_ForTextLabel](https://github.com/mahxn0/Yolov3_ForTextLabel) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2020-05-29 <img src="https://img.shields.io/github/stars/mahxn0/Yolov3_ForTextLabel?style=social"/> : 基于yolov3的目标/自然场景文字自动标注工具。

    * [whs0523003/YOLOv5\_6.1\_autolabel](https://github.com/whs0523003/YOLOv5_6.1_autolabel) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2022-09-28 <img src="https://img.shields.io/github/stars/whs0523003/YOLOv5_6.1_autolabel?style=social"/> : YOLOv5\_6.1 自动标记目标框。

  * #### Data Augmentation

    * [Albumentations](https://github.com/albumentations-team/albumentations) ⚠️ Archived <img src="https://img.shields.io/github/stars/albumentations-team/albumentations?style=social"/> : Albumentations is a Python library for image augmentation. Image augmentation is used in deep learning and computer vision tasks to increase the quality of trained models. The purpose of image augmentation is to create new training samples from the existing data. "Albumentations: Fast and Flexible Image Augmentations". (**[Information 2020](https://www.mdpi.com/2078-2489/11/2/125)**)

    * [doubleZ0108/Data-Augmentation](https://github.com/doubleZ0108/Data-Augmentation) ⭐ 16 | 🐛 3 | 🌐 Python | 📅 2023-04-14 <img src="https://img.shields.io/github/stars/doubleZ0108/Data-Augmentation?style=social"/> : General Data Augmentation Algorithms for Object Detection(esp. Yolo).

  * #### Data Management

    * [YOLOExplorer](https://github.com/lancedb/yoloexplorer) ⭐ 144 | 🐛 6 | 🌐 Python | 📅 2026-09-07 <img src="https://img.shields.io/github/stars/lancedb/yoloexplorer?style=social"/> : YOLOExplorer : Iterate on your YOLO / CV datasets using SQL, Vector semantic search, and more within seconds. Explore, manipulate and iterate on Computer Vision datasets with precision using simple APIs. Supports SQL filters, vector similarity search, native interface with Pandas and more.
...
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 847 | 🐛 33 | 🌐 Python | 📅 2025-05-07 <img src="https://img.shields.io/github/stars/ZhaoJ9014/Anti-UAV?style=social"/> : 🔥🔥Official Repository for Anti-UAV🔥🔥. "Evidential Detection and Tracking Collaboration: New Problem, Benchmark and Algorithm for Robust Anti-UAV System". (**[arXiv 2023](https://arxiv.org/abs/2306.15767)**)

## Optical Aerial Imagery Datasets

* [VisDrone](https://github.com/VisDrone/VisDrone-Dataset) ⭐ 2,560 | 🐛 51 | 📅 2023-09-24 <img src="https://img.shields.io/github/stars/VisDrone/VisDrone-Dataset?style=social"/> : "Detection and Tracking Meet Drones Challenge". (**[IEEE TPAMI 2021](https://ieeexplore.ieee.org/abstract/document/9573394)**)
...
* [SeaDronesSee](https://github.com/Ben93kie/SeaDronesSee) ⭐ 120 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2023-12-13 <img src="https://img.shields.io/github/stars/Ben93kie/SeaDronesSee?style=social"/> : "SeaDronesSee: A Maritime Benchmark for Detecting Humans in Open Water". (**[WACV 2022](https://openaccess.thecvf.com/content/WACV2022/html/Varga_SeaDronesSee_A_Maritime_Benchmark_for_Detecting_Humans_in_Open_Water_WACV_2022_paper.html)**)

* [COWC](https://github.com/LLNL/cowc) ⭐ 115 | 🐛 4 | 🌐 Python | 📅 2021-01-29 <img src="https://img.shields.io/github/stars/LLNL/cowc?style=social"/> : "A large contextual dataset for classification, detection and counting of cars with deep learning". (**[ECCV 2016](https://link.springer.com/chapter/10.1007/978-3-319-46487-9_48)**)

* [LEVIR-Ship](https://github.com/WindVChen/LEVIR-Ship) ⭐ 105 | 🐛 1 | 🌐 Python | 📅 2023-07-15 <img src="https://img.shields.io/github/stars/WindVChen/LEVIR-Ship?style=social"/> : "A Degraded Reconstruction Enhancement-based Method for Tiny Ship Detection in Remote Sensing Images with A New Large-scale Dataset". (**[IEEE TGRS 2022](https://ieeexplore.ieee.org/abstract/document/9791363)**)

* [PESMOD](https://github.com/mribrahim/PESMOD) ⭐ 58 | 🐛 0 | 🌐 C++ | 📅 2023-01-10 <img src="https://img.shields.io/github/stars/mribrahim/PESMOD?style=social"/> : "UAV Images Dataset for Moving Object Detection from Moving Cameras". (**[arXiv 2021](https://arxiv.org/abs/2103.11460)**)
...
* [V2X-ViT|V2XSet](https://github.com/DerrickXuNu/v2x-vit) ⭐ 349 | 🐛 7 | 🌐 Python | 📅 2024-09-06 <img src="https://img.shields.io/github/stars/DerrickXuNu/v2x-vit?style=social"/> : "V2X-ViT: Vehicle-to-Everything Cooperative Perception with Vision Transformer". (**[ECCV, 2022](https://link.springer.com/chapter/10.1007/978-3-031-19842-7_7)**).

* [PJLab-ADG/LiDARSimLib-and-Placement-Evaluation](https://github.com/PJLab-ADG/LiDARSimLib-and-Placement-Evaluation) ⭐ 270 | 🐛 14 | 🌐 Python | 📅 2025-06-12 <img src="https://img.shields.io/github/stars/PJLab-ADG/LiDARSimLib-and-Placement-Evaluation?style=social"/> : "Analyzing Infrastructure LiDAR Placement with Realistic LiDAR Simulation Library". (**[ICRA, 2023](https://arxiv.org/abs/2211.15975)**).
